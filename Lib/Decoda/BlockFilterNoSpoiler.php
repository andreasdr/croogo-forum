 ...
 */
class BlockFilterNoSpoiler extends AbstractFilter {
    ...
    protected $_config = array(
        'spoilerToggle' => "$('#spoiler-content-{id}').toggle(); $('#spoiler-button-{id}').text('Spoiler (' + ($('#spoiler-content-{id}').is(':visible')?'Hide':'Show') + ')');"
    );
