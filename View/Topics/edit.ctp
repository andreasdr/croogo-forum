...
<div class="forum-container">
    ...
    echo $this->Form->input('FirstPost.content', array(
        'label' => '<div class="wysiwygeditor">' . __d('forum', 'Content') . '</div>',
        'type' => 'textarea',
        'rows' => 15
    ));

    echo $this->element('wysiwyg-editor', array('id' => 'FirstPostContent'));
    echo $this->Form->submit(__d('forum', 'Edit Topic'), array('class' => 'button success large'));
    echo $this->Form->end(); ?>
