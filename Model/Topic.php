...
class Topic extends ForumAppModel {
     ...
     * @return array
     */
    public function getAnnouncementsInForum($forum_id) {
        return $this->find('all', array(
            'order' => array('LastPost.created' => 'DESC'),
            'conditions' => array(
				'Topic.type' => self::ANNOUNCEMENT,
    ...
    /**
     * Get all sticky topics within a forum.
     *
     * @param int $forum_id
     * @return array
     */
    public function getStickiesInForum($forum_id) {
    	return $this->find('all', array(
    		'order' => array('Topic.type' => 'DESC', 'LastPost.created' => 'DESC'),
			'conditions' => array(
