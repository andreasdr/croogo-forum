...
class StationsController extends ForumAppController {
     ...
     * @type array
     */
    public $components = array('Forum.AjaxHandler', 'RequestHandler');
    ...
    public function view($slug) {
		...
		$topics = array_merge($this->Forum->Topic->getStickiesInForum($forum['Forum']['id']), $this->paginate('Topic'));
        $this->set('forum', $forum);
        $this->set('topics', $topics);
        $this->set('announcements', $this->Forum->Topic->getAnnouncementsInForum($forum['Forum']['id']));
