...
class TopicsController extends ForumAppController {
     ...
     * @type array
     */
    public $uses = array('Forum.Topic', 'Forum.Subscription', 'Forum.Report');
    ...
    public function report($slug) {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Report->createReportTopic($data['type'], $topic['Topic']['id'], $data['comment'], $user_id, $topic['Topic']['user_id']) === false) {
